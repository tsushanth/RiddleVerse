...
//  PuzzleForge
//
//  Registers Apple Search Ads (ASA) attribution token with Apple so the
//  conversion is recorded for the install. Token is fetched on-device via
//  AdServices and POSTed once to api-adservices.apple.com.
//
