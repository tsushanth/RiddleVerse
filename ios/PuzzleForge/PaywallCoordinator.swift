...
final class PaywallCoordinator: ObservableObject {
    ...
    private enum Keys {
        static let dismissCount = "com.kreativekoala.riddleverse.paywallDismissCount"
        static let lastDismissDate = "com.kreativekoala.riddleverse.paywallLastDismissDate"
        static let lastWinbackShownDate = "com.kreativekoala.riddleverse.lastWinbackShownDate"
    }
